        ...
        with slim.arg_scope([slim.conv2d, slim.max_pool2d, slim.avg_pool2d], stride=1, padding='SAME'):
            with tf.variable_scope('Mixed_5b'):
                ...
                with tf.variable_scope('Branch_3'):
                    branch_3 = slim.avg_pool2d(net, [3,3], scope='Avg_Pool_0a_3x3')
            ...
            with tf.variable_scope('Mixed_6b'):
                ...
                with tf.variable_scope('Branch_2'):
                    ...
                    branch_2 = slim.conv2d(branch_2, 192, [1, 7], scope='Conv2d_0b_1x7')
                with tf.variable_scope('Branch_3'):
            ...
            with tf.variable_scope('Mixed_7b'):
                ...
                with tf.variable_scope('Branch_3'):
                    ...
                    branch_3 = slim.conv2d(branch_3, 192, [1,1], scope='Conv3d_0b_1x1')
                net = tf.concat([branch_0, branch_1, branch_2, branch_3], axis=3)
    ...
    with tf.variable_scope(scope, 'InceptionV3', [inputs, num_classes], reuse=reuse) as scope:
        ...
        with slim.arg_scope([slim.conv2d, slim.max_pool2d, slim.avg_pool2d], stride=1, padding='SAME'):
            ...
            with tf.variable_scope('AuxLogits'):
                ...
                aux_logits = slim.conv2d(aux_logits, 768, [5,5], weight_initializer=trunc_normal(stddev=0.01),
